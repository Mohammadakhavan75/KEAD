...
if args.transform:
    cifar_train_cor_img_path = f'/finals/datasets/generalization_repo_dataset/CIFAR-10-R-A/{args.aug}.npy'
    cifar_train_cor_target_path = '/finals/datasets/generalization_repo_dataset/CIFAR-10-R-A/labels-A.npy'
    aug_dataset = load_np_dataset(cifar_train_cor_img_path, cifar_train_cor_target_path, transform=transform)
elif args.aug:
    cifar_train_cor_img_path = f'/finals/datasets/generalization_repo_dataset/CIFAR-10-R-C/{args.aug}.npy'
    cifar_train_cor_target_path = '/finals/datasets/generalization_repo_dataset/CIFAR-10-R-C/labels-C.npy'
    aug_dataset = load_np_dataset(cifar_train_cor_img_path, cifar_train_cor_target_path, transform=transform)
